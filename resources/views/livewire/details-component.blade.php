                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{ route('product.details', ['slug'=>$related_product->slug]) }}" tabindex="0">
                                                            <img class="default-img" src="{{ asset('assets/imgs/shop/product-')}}{{ $related_product->id }}-1.jpg" alt="{{ $related_product->name }}">
                                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-')}}{{ $related_product->id }}-2.jpg" alt="{{ $related_product->name }}">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="product-content-wrap">
                                                    ...
                                                    <div class="product-price">
                                                        <span>$ {{ $related_product->regular_price }} </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{ asset('assets/imgs/shop/product-')}}{{$new_product->id}}-1.jpg" alt="product image">
                                </div>
                                <div class="content pt-10">
                                    <h5><a href="{{ route('product.details',['slug'=>$new_product->slug]) }}">{{ $new_product->name }}</a></h5>
